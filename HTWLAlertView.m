   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        UIImageView * view = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kAlertWidth, kAlertHeight)];
        view.image = [UIImage imageNamed:@"dbj.png"];
        [self addSubview:view];
        
        self.alertTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(20, kTitleYOffset, kAlertWidth - 40, kTitleHeight)];
        self.alertTitleLabel.font = [UIFont systemFontOfSize:16.0f];
        self.alertTitleLabel.textColor = [UIColor orangeColor];
        self.alertTitleLabel.textAlignment = NSTextAlignmentLeft;
        [self addSubview:self.alertTitleLabel];
        
        CGFloat contentLabelWidth = kAlertWidth - 16;
        self.alertContentLabel = [[UILabel alloc] initWithFrame:CGRectMake((kAlertWidth - contentLabelWidth) * 0.5 + 12, CGRectGetMaxY(self.alertTitleLabel.frame), contentLabelWidth - 24, 60)];
        ...
        self.alertContentLabel.font = [UIFont systemFontOfSize:11.0f];
        [self addSubview:self.alertContentLabel];
        
        CGRect leftBtnFrame;
        CGRect rightBtnFrame;
#define kSingleButtonWidth 160.0f
#define kCoupleButtonWidth 70.0f
...
#define kButtonBottomOffset 30.0f
        if (!leftTitle) {
            ...
            leftBtnFrame = CGRectMake((kAlertWidth - 2 * kCoupleButtonWidth - kButtonBottomOffset) * 0.5, kAlertHeight - kButtonBottomOffset - kButtonHeight, kCoupleButtonWidth+5, kButtonHeight);
            rightBtnFrame = CGRectMake(CGRectGetMaxX(leftBtnFrame) + kButtonBottomOffset-10, kAlertHeight - kButtonBottomOffset - kButtonHeight, kCoupleButtonWidth+5, kButtonHeight);
        ...
        [self.rightBtn setBackgroundImage:[UIImage imageNamed:@"tcbj.png"] forState:UIControlStateNormal];
        [self.leftBtn setBackgroundImage:[UIImage imageNamed:@"cxdlbj.png"] forState:UIControlStateNormal];
